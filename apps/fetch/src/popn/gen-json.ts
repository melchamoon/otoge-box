...
const versions = [
  ...
  { releaseDate: "2022-09-13", version: "pop'n music UniLab" },
  {
    ...
    version: "pop'n music Jam&Fizz",
    abbr: "pop'n Jam&Fizz (Not complete)",
  },
  {
    releaseDate: "2025-12-18",
    version: "pop'n music High☆Cheers!!",
    abbr: "pop'n music High☆Cheers!! (Not complete)",
  },
...
const regions = [{ region: "jp", name: "日本版" }];
