...
const difficulties = [
  ...
  },
  {
    ...
    name: "裏おに",
    color: "#106479",
    iconUrl: "difficulty-ura_oni.png",
    iconHeight: 25,
  },
];
const regions = [
