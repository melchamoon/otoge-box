...
const DATA_URL =
  "https://maimaidx.jp/maimai-mobile/record/musicVersion/search/";
...
async function getJpCookies() {
  ...
  await Promise.all([
    ...
    page.click(
      'form[action="https://maimaidx.jp/maimai-mobile/submit/"] button[type="submit"]',
    ),
  ]);
  ...
  await Promise.all([
    page.waitForNavigation(),
    page.click(
      'form[action="https://maimaidx.jp/maimai-mobile/aimeList/submit/"] button[type="submit"]',
    ),
  ]);
