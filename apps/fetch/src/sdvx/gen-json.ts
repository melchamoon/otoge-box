...
const versions = [
  { releaseDate: "2012-01-18", version: "BOOTH", abbr: "[I] BOOTH" },
  {
    ...
    version: "INFINITE INFECTION",
    abbr: "[II] INFINITE INFECTION",
  },
  {
    releaseDate: "2014-11-20",
    version: "GRAVITY WARS",
    abbr: "[III] GRAVITY WARS",
  },
  {
    releaseDate: "2016-12-21",
    version: "HEAVENLY HAVEN",
    abbr: "[IV] HEAVENLY HAVEN",
  },
...
const regions = [{ region: "jp", name: "日本版" }] as any[];
