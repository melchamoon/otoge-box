...
const versions = [
  {
    ...
    version: "GROOVE COASTER",
    abbr: "[1] GROOVE COASTER",
  },
  {
    releaseDate: "2014-05-26",
    version: "GROOVE COASTER EX",
    abbr: "[EX] GROOVE COASTER EX",
  },
  {
    releaseDate: "2015-01-22",
    version: "HEAVENLY FESTIVAL",
    abbr: "[2] HEAVENLY FESTIVAL",
  },
  { releaseDate: "2016-03-10", version: "LINK FEVER", abbr: "[3] LINK FEVER" },
  {
    releaseDate: "2017-03-16",
    version: "DREAM PARTY",
    abbr: "[3EX] DREAM PARTY",
  },
  {
    releaseDate: "2018-03-29",
    version: "STARLIGHT ROAD",
    abbr: "[4] STARLIGHT ROAD",
  },
  {
    releaseDate: "2019-03-28",
    version: "INFINITY∞HIGHWAY",
    abbr: "[4EX] INFINITY∞HIGHWAY",
  },
  {
    releaseDate: "2020-04-09",
    version: "DIAMOND GALAXY",
    abbr: "[4MAX] DIAMOND GALAXY",
  },
...
export default async function run() {
  ...
  const songRecords = await sequelize.query(
    /* sql */ `
    SELECT
      *
    FROM "Songs"
  ...
  const sheetRecords = await sequelize.query(
    /* sql */ `
    SELECT
      *
    FROM "Sheets"
